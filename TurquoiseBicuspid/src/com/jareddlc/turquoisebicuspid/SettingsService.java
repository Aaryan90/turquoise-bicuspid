...
public class SettingsService extends Service {
	...
	private BroadcastReceiver smsReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			bluetooth.send(pref_sms_type, pref_sms_loop, pref_sms_time, pref_sms_repeat);
		}
	};
	...
	private BroadcastReceiver phoneReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			bluetooth.send(pref_phone_type, pref_phone_loop, pref_phone_time, pref_phone_repeat);
		}
	};
}

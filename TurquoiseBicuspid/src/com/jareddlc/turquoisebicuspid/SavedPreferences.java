...
public class SavedPreferences {
    ...
    public String saved_preference_list_sms_number_value;
    public String saved_preference_list_sms_number_entry;
    ...
    public String saved_preference_list_phone_number_value;
    public String saved_preference_list_phone_number_entry;
    ...
    public void load(Context context) {
        ...
        saved_preference_list_sms_number_value = preferences.getString("saved_preference_list_sms_number_value", PREFS_DEFAULT);
        saved_preference_list_sms_number_entry = preferences.getString("saved_preference_list_sms_number_entry", PREFS_DEFAULT);
        ...
        saved_preference_list_phone_number_value = preferences.getString("saved_preference_list_phone_number_value", PREFS_DEFAULT);
        saved_preference_list_phone_number_entry = preferences.getString("saved_preference_list_phone_number_entry", PREFS_DEFAULT);

...
import com.jareddlc.turquoisebicuspid.ColorPickerDialog.OnColorPickerListener;
...
public class ColorPickerPreference extends Preference {
	...
	public ColorPickerPreference(Context context, AttributeSet attrs) {
        ...
        setWidgetLayoutResource(R.layout.colorpicker_preference_widget);
	}
    ...
    protected void onBindView(View view) {
        ...
        final View box = view.findViewById(R.id.colorpicker_preference_widget_box);
        if(box != null) {
    ...
    protected void onClick() {
		new ColorPickerDialog(getContext(), value, supportsAlpha, new OnColorPickerListener() {
